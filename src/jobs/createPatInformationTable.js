...
const result = require("dotenv").config({
  ...
  const SPREADSHEET_NAME = "Pat Information";
  const SPREADSHEET_WORKSHEET_NAME = "Pat Information"; // for the "Reiter" of a spreadsheet
  
  const LYMEDIA_SEARCH_TITLE = "gesundheitsinformation.de";
