...
(async function () {
  ...
  const SPREADSHEET_NAME = "Not Implemented List";
  const SPREADSHEET_WORKSHEET_NAME = "Not Implemented List"; // for the "Reiter" of a spreadsheet
  ...
  const LYMEDIA_SEARCH_REQUIRE_TAGS = "bild:bildtyp=Illustration";
